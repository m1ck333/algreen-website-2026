...
export const ui = {
  sr: {
    ...
    home: {
      ...
      showcase: {
        configKicker: 'Konfigurator',
        configHeading: 'Kreirajte svoja vrata',
        configText:
          'Kreirajte ulazna vrata po svojoj meri. Izaberite model, dimenzije, materijale, boje i dodatnu opremu, a konfigurator će odmah prikazati konačan izgled i okvirnu cenu — bez čekanja na ponudu.',
        configCta: 'Započnite konfiguraciju',
        doorsHeading: 'Ekskluzivna ulazna vrata',
        tiles: [
          { label: 'Katalog', img: '/img/design/catalog.webp' },
          { label: 'Rukohvati', img: '/img/design/handles.webp' },
          { label: 'Kontrola pristupa', img: '/img/design/access-control.webp' },
          { label: 'Tehnički detalji', img: '/img/design/technical.webp' },
        ],
        offerKicker: 'Naša ponuda',
        offerText:
          'Kompletna rešenja za eksterijer i enterijer — ulazna vrata, pivot sistemi, staklene ograde i pregrade, tuš kabine, kapije, dvorišne ograde i nadstrešnice, izrađeni po meri svakog projekta.',
        offerSoon: 'Uskoro i Invisible Door sistemi.',
        products: [
          { label: 'Pergole', img: '/img/design/pergolas.webp' },
          { label: 'Kapije', img: '/img/design/gates.webp' },
          { label: 'Balkonske ograde', img: '/img/design/balcony-railings.webp' },
          { label: 'Stepenišne ograde', img: '/img/design/stair-railings.webp' },
          { label: 'Ulazne nadstrešnice', img: '/img/design/canopies.webp' },
          { label: 'Tuš kabine', img: '/img/design/shower-cabins.webp' },
          { label: 'Office sistemi', img: '/img/design/office-systems.webp' },
          { label: 'Lamele', img: '/img/design/lamellas.webp' },
          { label: 'Staklene pregrade', img: '/img/design/glass-partitions.webp' },
        ],
        worksHeading: 'Naši radovi',
        worksCta: 'Pogledajte sve radove',
      },
    },
    statsLabels: {
      branches: 'poslovnice',
  ...
  en: {
    ...
    home: {
      ...
      showcase: {
        configKicker: 'Configurator',
        configHeading: 'Create your door',
        configText:
          'Create an entrance door made to your measure. Choose the model, dimensions, materials, colours and accessories, and the configurator instantly shows the final look and an estimated price — no waiting for a quote.',
        configCta: 'Start configuring',
        doorsHeading: 'Exclusive entrance doors',
        tiles: [
          { label: 'Catalog', img: '/img/design/catalog.webp' },
          { label: 'Handrails', img: '/img/design/handles.webp' },
          { label: 'Access control', img: '/img/design/access-control.webp' },
          { label: 'Technical details', img: '/img/design/technical.webp' },
        ],
        offerKicker: 'Our offer',
        offerText:
          'Complete solutions for exterior and interior — entrance doors, pivot systems, glass railings and partitions, shower cabins, gates, yard fences and canopies, made to measure for every project.',
        offerSoon: 'Invisible Door systems coming soon.',
        products: [
          { label: 'Pergolas', img: '/img/design/pergolas.webp' },
          { label: 'Gates', img: '/img/design/gates.webp' },
          { label: 'Balcony railings', img: '/img/design/balcony-railings.webp' },
          { label: 'Staircase railings', img: '/img/design/stair-railings.webp' },
          { label: 'Entrance canopies', img: '/img/design/canopies.webp' },
          { label: 'Shower cabins', img: '/img/design/shower-cabins.webp' },
          { label: 'Office systems', img: '/img/design/office-systems.webp' },
          { label: 'Lamellas', img: '/img/design/lamellas.webp' },
          { label: 'Glass partitions', img: '/img/design/glass-partitions.webp' },
        ],
        worksHeading: 'Our works',
        worksCta: 'See all works',
      },
    },
    statsLabels: {
      branches: 'branches',
